        ...
        <nav id="nav-wrap">         
          ...
          <a class="mobile-btn" href="#" title="Hide navigation">
           ...
           <ul id="nav" class="nav">
             ...
             <li><a class="#" href="http://localhost/art/admin/artists1.php">Artists</a></li>
...
<div align="center" >
              <?php
                  ...
                  echo '<a href="buy.php"><img src="'.$row['image'].'" width=300 height=300></a>';
                  }
                  ?>
