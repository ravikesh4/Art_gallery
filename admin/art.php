    ...
    <div class="row header-inner">
        ...
        <nav id="nav-wrap">         
          ...
          <a class="mobile-btn" href="#" title="Hide navigation">
           ...
           <ul id="nav" class="nav">
              <li class="current"><a class="#" href="http://localhost/art/index.php">Home</a></li>
             <li><a class="#" href="http://localhost/art/admin/artists.php">Artists</a></li>
              <li><a class="#" href="http://localhost/art/art_service.php">Categories</a></li>
              <li><a class="#" href="exibition.php">Exhibition</a></li>
              <li><a class="#" href="http://localhost/art/art_about.php">About</a></li>
              <li><a class="#" href="http://localhost/art/art_contact.php">Contact</a></li>
              <li><a class="#" href="http://localhost/art/login.php">Login</a></li>
...
<section id="portfolio">
      ...
      <div class="row section-head">
      	...
      	<div class="twelve columns">
	         ...
	         <h1>Our Latest Arts<span>.</span></h1>
    ...
    $("z").click(function(){
        alert("Please Login First.");
              ...
              <?php
                  ...
                  echo '<z><a href="#"><img src="'.$row['image'].'" width=300 height=300></a></z>';
