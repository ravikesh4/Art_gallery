...
<body class="homepage">
   ...
   <header id="main-header">
    ...
    <div class="row header-inner">
        ...
        <div class="logo">
           <a class="#" href="index1.php">Art Gallery</a>
        </div>
        ...
        <nav id="nav-wrap">         
          ...
          <a class="mobile-btn" href="#" title="Hide navigation">
           ...
           <ul id="nav" class="nav">
              <li class="current"><a class="#" href="http://localhost/art/index1.php">Home</a></li>
             <li><a class="#" href="artists1.php">Artists</a></li>
              <li><a class="#" href="http://localhost/art/art_service1.php">Categories</a></li>
              <li><a class="#" href="exibition1.php">Exhibition</a></li>
              <li><a class="#" href="http://localhost/art/art_about1.php">About</a></li>
              <li><a class="#" href="http://localhost/art/art_contact1.php">Contact</a></li>
              <li><a class="#" href="http://localhost/art/logout.php">Logout</a></li>
...
<div align="center" >
              ...
              <?php
                  include('config.php');
                  $result = mysql_query("SELECT * FROM art limit 1");
                  while($row = mysql_fetch_array($result))
                  {

                  echo '<a href="#"><img src="'.$row['image'].'" width=500 height=500></a>';
                  }
                  ?>
                  <h2><b>Price: 20000</b></h2>
